...
type HowItWorksStackScreenContent = {
  screenNumber: number
...
interface HowItWorksStackScreenProps {
  HowItWorksStackScreenContent: HowItWorksStackScreenContent
  totalScreenCount: number
  destinationOnSkip: Stack
}

const HowItWorksStackScreen: FunctionComponent<HowItWorksStackScreenProps> = ({
  HowItWorksStackScreenContent,
  totalScreenCount,
  destinationOnSkip,
}) => {
    ...
    <>
      ...
      <View style={style.outerContainer}>
        ...
        >
          <View>
            <Image
              source={HowItWorksStackScreenContent.image}
              accessibilityLabel={HowItWorksStackScreenContent.imageLabel}
              accessible
              style={style.image}
              resizeMode={"contain"}
            />
            <PositionDots
              highlightedDotIdx={HowItWorksStackScreenContent.screenNumber}
              totalDotCount={totalScreenCount}
            />
            <GlobalText style={style.headerText}>
              {HowItWorksStackScreenContent.header}
            </GlobalText>
          </View>
        </ScrollView>
        <View style={style.bottomButtonContainer}>
          <>
            <Button
              ...
              label={HowItWorksStackScreenContent.primaryButtonLabel}
              onPress={HowItWorksStackScreenContent.primaryButtonOnPress}
              hasRightArrow
            />
